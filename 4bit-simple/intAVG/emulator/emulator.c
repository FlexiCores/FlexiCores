...
int unsigned_to_signed(uint8_t num);
...
// Used to convert unsigned output from OPORT to unsigned.
int unsigned_to_signed(uint8_t num)
{
    if(num > 15)
    {
    ...
    while (ncycles--) {
        ...
        switch (st) 
        {
            ...
            case OTHER_1:
                ...
                {
                    st = INPUT_0;
                    as.RF[1] = read_input("Enter input x(t): ");
                }
                break;
            case INPUT_0:
                if(oport_lower == 3)
            ...
            case OUTPUT_WAIT_1:
                st = OUTPUT_DISPLAYED;
                printf("=======================================\n");
                printf("Output y(t): %0d\n", unsigned_to_signed(as.RF[0]) );
                printf("=======================================\n");
                break;
